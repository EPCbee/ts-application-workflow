import type { Applicant, Application, ApplicationType, ApplicationStatus } from '$lib/types/application';
import { APPLICATION_TYPES, typeLabels, statusLabels } from '$lib/constants';
