    ...
    container.innerHTML = `
      <div class="card">
        ...
        <form id="appForm">
          ...
          <div id="dynamicFields" style="margin-top:8px;"></div>
        ...
        <div class="modal-overlay" id="modalOverlay">
          <div class="modal">
            ...
            <div class="modal-body">
              <div style="margin-bottom:8px;"><strong>申请人：</strong>${applicant.name} (${applicant.department})</div>
              <div style="margin-bottom:8px;"><strong>类型：</strong>${typeLabels[type]}</div>
              <div style="margin-bottom:8px;"><strong>标题：</strong>${title}</div>
              <div><strong>内容：</strong></div>
              <div style="margin-top:8px;background:#fafafa;padding:12px;border-radius:4px;">${fieldsHTML}</div>
            </div>
